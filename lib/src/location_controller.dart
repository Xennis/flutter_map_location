...
class LocationControllerImpl implements LocationController {
  ...
  Stream<LatLngData> subscribePosition(Duration intervalDuration, LocationAccuracy locationAccuracy) {
    _isSubscribed = true;
    _onLocationChangedSub =
        Geolocator.getPositionStream(intervalDuration: intervalDuration, desiredAccuracy: locationAccuracy).listen(
            (Position ld) {
      _controller
